...
class ConfigReader {
	public:
		...
		std::tr1::unordered_map<std::string, std::tr1::unordered_map<std::string, std::string> > servers(bool connecting);
		std::tr1::unordered_map<std::string, std::tr1::unordered_map<std::string, std::string> > modules(bool loading);
	private:
