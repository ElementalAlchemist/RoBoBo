...
class Module {
	public:
		...
		virtual void onUserOperPre(std::string server, std::string client, std::string user, std::string opertype);
		virtual void onUserOperPost(std::string server, std::string client, std::string user, std::string opertype);
