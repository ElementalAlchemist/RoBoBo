...
std::set<std::string> ServerManager::serverCapabilities(const std::string& server) {
	return callClientHook(&ClientProtocol::serverCapabilities, server);
}
...
std::string ServerManager::idFromNick(const std::string& server, const std::string& nick) {
	return callEitherHook(&ClientProtocol::idFromNick, &ServerProtocol::idFromNick, server, std::forward<const std::string&>(nick));
}
...
std::string ServerManager::userModeParam(const std::string& server, const std::string& user, const std::string& mode) {
	return callEitherHook(&ClientProtocol::userModeParam, &ServerProtocol::userModeParam, server, std::forward<const std::string&>(user), std::forward<const std::string&>(mode));
}
