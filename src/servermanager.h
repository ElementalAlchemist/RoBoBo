...
class ServerManager {
	public:
		...
		void sendPing(const std::string& server, const std::string& data, const std::map<std::string, std::string>& tags) { callEitherHook(&ClientProtocol::sendPing, &ServerProtocol::sendPing, server, std::forward<const std::string>(data), std::forward<const std::map<std::string, std::string>>(tags)); }
		...
		void setUnaway(const std::string& server, const std::string& client, const std::map<std::string, std::string>& tags) { callEitherHook(&ClientProtocol::setUnaway, &ServerProtocol::setUnaway, server, std::forward<const std::string>(client), std::forward<const std::string>(tags)); }
		...
		std::pair<std::string, char> compareStatus(const std::string& server, const std::string& status0, const std::string& status1) { return callEitherHook(&ClientProtocol::compareStatus, &ServerProtocol::compareStatus, server, std::forward<const std::string>(status0), std::forward<const std::string>(status1)); }
		std::pair<std::string, char> compareStatus(const std::string& server, const std::string& status0, char status1) { return callEitherHook(&ClientProtocol::compareStatus, &ServerProtocol::compareStatus, server, std::forward<const std::string>(status0), std::forward<char>(status1)); }
		std::pair<std::string, char> compareStatus(const std::string& server, char status0, const std::string& status1) { return callEitherHook(&ClientProtocol::compareStatus, &ServerProtocol::compareStatus, server, std::forward<const std::string>(status1), std::forward<char>(status0)); }
		...
		bool userHasStatus(const std::string& server, const std::string& channel, const std::string& user, const std::string& status) { return callEitherHook(&ClientProtocol::userHasStatus, &ServerProtocol::userHasStatus, server, std::forward<const std::string>(channel), std::forward<const std::string>(user), std::forward<const std::string>(status)); }
		bool userHasStatus(const std::string& server, const std::string& channel, const std::string& user, char status) { return callEitherHook(&ClientProtocol::userHasStatus, &ServerProtocol::userHasStatus, server, std::forward<const std::string>(channel), std::forward<const std::string>(user), std::forward<char>(status)); }
		bool userHasStatusOrGreater(const std::string& server, const std::string& channel, const std::string& user, const std::string& status) { return callEitherHook(&ClientProtocol::userHasStatusOrGreater, &ServerProtocol::userHasStatusOrGreater, server, std::forward<const std::string>(channel), std::forward<const std::string>(user), std::forward<const std::string>(status)); }
		bool userHasStatusOrGreater(const std::string& server, const std::string& channel, const std::string& user, char status) { return callEitherHook(&ClientProtocol::userHasStatusOrGreater, &ServerProtocol::userHasStatusOrGreater, server, std::forward<const std::string>(channel), std::forward<const std::string>(user), std::forward<char>(status)); }
