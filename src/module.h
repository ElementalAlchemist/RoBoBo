...
enum ProtoLoadResult { PROTO_SUCCESS, PROTO_ALREADYLOADED, PROTO_NOCONFIG, PROTO_NOPROTOCOL, PROTO_OPEN_ERROR, PROTO_OUT_OF_MEMORY, PROTO_INCOMPATIBLE };
...
class Module {
	public:
		...
		virtual void onChanStatus(const std::string& server, const std::string& channel, bool add, const std::string& user, const std::string& rank) {}
		...
		virtual void onNumeric(const std::string& server, const std::string& client, const std::string& numeric, const std::vector<std::string>& data) {}
	...
	protected:
		...
		ProtoLoadResult connectServer(const std::string& server);
