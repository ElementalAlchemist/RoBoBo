...
class Protocol {
	...
	protected:
		...
		void callUserOperPreHook(std::string client, std::string user, std::string opertype);
		void callUserOperPostHook(std::string client, std::string user, std::string opertype);
